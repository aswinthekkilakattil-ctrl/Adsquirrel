export const defaultSiteContent = {
  ...
  services: {
    ...
    items: [
      ...
      },
      {
        ...
        desc: 'TikTok, Insta, and X campaigns that help your brand travel fast.',
        color: '#f472b6',
      },
      {
        icon: '\uD83C\uDFA8',
        title: 'Brand Identity',
        desc: 'From logos to full identity systems, we craft brands that are unforgettable.',
        color: '#22d3ee',
      },
      {
        icon: '\uD83D\uDCC8',
      ...
      },
      {
        ...
        desc: 'Cinematic ads, viral shorts, and content that stops thumbs mid-scroll.',
        color: '#fbbf24',
      },
      {
        icon: '\uD83D\uDD0D',
  ...
  results: {
    bgText: 'RESULTS',
    items: [
      { number: '500+', label: 'Clients Served', icon: '\uD83D\uDC3F\uFE0F' },
      { number: '2.5B', label: 'Ad Impressions', icon: '\uD83D\uDC40' },
  ...
  testimonials: {
    ...
    items: [
      {
        text: 'We were just getting started with marketing, and the team made everything easy to understand. They helped us improve our page and bring in steady enquiries.',
        author: 'Anjali Nair',
        role: 'Small Business Owner',
        avatar: '\uD83D\uDC69\u200D\uD83D\uDCBC',
      },
      {
        text: 'As a beginner, I liked that they explained each step clearly and did not overcomplicate things. The content and ads felt much more professional after working with them.',
        author: 'Rahul Menon',
        role: 'Startup Founder',
        avatar: '\uD83D\uDC68\u200D\uD83D\uDCBB',
      },
      {
        text: 'We wanted simple support for social media and branding, and that is exactly what we got. The team was friendly, quick to respond, and easy to work with.',
        author: 'Priya Thomas',
        role: 'Freelancer',
        avatar: '\uD83D\uDC69\u200D\uD83C\uDFA8',
      },
